...
//typedef struct {
//	Class class;
//	__unsafe_unretained DKCanvasView *scriptView;
...
//	DKCanvasView *scriptView = (__bridge DKCanvasView *)(JSObjectGetPrivate(object));
//	
//	JSObjectRef obj = NULL;
//	NSString *fullClassName = [@EJ_BINDING_CLASS_PREFIX stringByAppendingString:(__bridge NSString *)className];
...
//	DKCanvasView *scriptView = classWithScriptView->scriptView;
//	
...
//	EJClassWithScriptView *classWithScriptView = (EJClassWithScriptView *)JSObjectGetPrivate(constructor);
//	id instance = (__bridge id)(JSValueGetPrivate(possibleInstance));
//	
...
//
//- (id)initWithScriptView:(DKCanvasView *)scriptView name:(NSString *)name {
//	if( self = [super init] ) {
...
//		
//		JSObjectRef loader = JSObjectMake(context, loaderClass, (__bridge void *)(scriptView));
...
//		constantValues = constantValuesp;
//	}
//	return self;
//}
//
